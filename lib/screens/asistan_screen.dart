...
class _AsistanScreenState extends State<AsistanScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _sesAyarla() async {
    ...
    try { await _tts.setVolume(0.85); } catch (_) {} // hafif kis -> mikrofona daha az echo kacar (barge-in)
  ...
  (Color, Color, IconData) _seviyeStil(String s) {
    switch (s) {
      case 'risk': return (const Color(0xFFF87171), const Color(0xFF2A1518), Icons.warning_amber_rounded);
